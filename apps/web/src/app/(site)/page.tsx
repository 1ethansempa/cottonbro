...
import { Logo, Button } from "@cottonbro/ui";
            ...
            {benefits.map((f, i) => (
              ...
              >
                <div className="h-full flex flex-col justify-between">
                  <div>
                    <h3 className="font-marcellus font-semibold text-3xl uppercase text-black group-hover:text-street-red transition-colors">{f.title}</h3>
        ...
        <section id="pricing" className="mx-auto max-w-7xl px-6 py-32 border-b border-black">
          ...
          <div className="flex justify-center">
            <div className="w-full max-w-2xl">
              ...
              >
                <h3 className="mb-6 font-urbanist text-4xl uppercase text-black md:text-5xl">Transparent Pricing</h3>
                <div className="mb-8 flex flex-col items-center gap-2">
                  <span className="text-6xl font-urbanist text-street-red">UGX 10k</span>
                  <span className="text-xl font-bold uppercase tracking-widest text-black">per sale</span>
                </div>
                ...
                <p className="mt-4 text-sm font-medium text-zinc-500 max-w-md">
                  No monthly fees. No hidden costs. You only pay when you make a sale.
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="mt-32">
            <h3 className="mb-12 text-center font-jamino text-4xl uppercase text-black md:text-5xl">Loved by creators</h3>
