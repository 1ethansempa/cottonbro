...
export function SiteHeader({
  ...
  return (
    <>
      <div
        className={`${position === "fixed" ? "fixed" : "relative"} inset-x-0 top-0 z-50 flex justify-center pointer-events-none`}
      >
        <header
              ...
              {!isAuthenticated ? (
                <>
                  ...
                  <MaybeLink
                    disabled={disableLinks}
                    href={startHref}
                    className={`inline-flex items-center gap-2 rounded-full px-6 py-3.5 text-[10px] font-bold uppercase tracking-[0.2em] transition-all duration-300 hover:opacity-80 ${
                      theme === "light"
                        ? "bg-black text-white"
                        : "bg-white text-black"
                    }`}
                ...
                <button
                  ...
                  className={`cursor-pointer rounded-full border px-6 py-3.5 text-[10px] font-bold uppercase tracking-[0.2em] transition-all disabled:opacity-60 hover:opacity-80 ${
                    theme === "light"
