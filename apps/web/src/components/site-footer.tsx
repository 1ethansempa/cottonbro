  ...
  return (
    ...
    >
      <div className="flex flex-col gap-2 mb-10 md:mb-0">
        ...
        <div
          className={`text-[10px] uppercase tracking-widest font-bold mt-1 text-gray-400`}
        >
          TERMS AND PRIVACY &middot; &copy; {new Date().getFullYear()} ALL
          RIGHTS RESERVED.
        </div>
      </div>
      ...
      <div className="flex flex-wrap gap-6 md:gap-10 items-center">
        <MaybeLink
          disabled={disableLinks}
          href="#"
          className={`text-[10px] font-bold tracking-widest uppercase transition-colors ${theme === "light" ? "hover:text-gray-400 text-black" : "hover:text-gray-400 text-white"}`}
        >
          TERMS
        </MaybeLink>
        <MaybeLink
